...
public class Transformation {
    ...
    private static class Holder {
        ...
        public static ImmutableList<IntBinaryOperator> X_TRANSFORMERS = ImmutableList.of(
                (x, y) -> x,
                (x, y) -> y,
                (x, y) -> -1 - x,
                (x, y) -> -1 - y,
        ...
        public static ImmutableList<IntBinaryOperator> Y_TRANSFORMERS = ImmutableList.of(
                (x, y) -> y,
                (x, y) -> -1 - x,
                (x, y) -> -1 - y,
                (x, y) -> x,
        ...
        private static ImmutableList<Transformation> ALL = Stream.of(Rotation.values())
